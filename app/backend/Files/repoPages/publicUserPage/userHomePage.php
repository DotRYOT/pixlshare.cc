  ...
  <div id="postSuspended" <?= $postStateVis; ?>>
    <div class="postSuspendedContainer">
      ...
      <div class="postSuspendedContent">
        <h2>This user has been suspended.</h2>
        ...
        <div class="userInfo">
          <?php if (isset($_SESSION['user']['UUID'])) { ?>
            <button id="followButton" onclick="followUser(this)">
              <svg xmlns="http://www.w3.org/2000/svg" id="followingPersonIcon" style="display: none;" height="48px"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="followingPersonIconPlus" height="48px" viewBox="0 -960 960 960"
